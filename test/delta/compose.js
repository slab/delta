...
describe('compose()', function () {
  it('insert + insert', function () {
    ...
    var b = new Delta(1).insert('B').retain(1);
  ...
  it('insert + retain', function () {
    var a = new Delta().insert('A');
    var b = new Delta(1).retain(1, { bold: true, color: 'red', font: null });
  ...
  it('insert + delete', function () {
    var a = new Delta().insert('A');
    var b = new Delta(1).delete(1);
    var expected = new Delta();
    expect(a.compose(b)).toEqual(expected);
  });

  it('delete + insert', function () {
    var a = new Delta(1).delete(1);
  ...
  it('delete + retain', function () {
    var a = new Delta(2).delete(1);
    var b = new Delta(1).retain(1, { bold: true, color: 'red' });
  ...
  xit('retain + retain', function () {
    var a = new Delta(1).retain(1, { color: 'blue' });
    var b = new Delta(1).retain(1, { bold: true, color: 'red', font: null });
    var expected = new Delta(1).retain(1, { bold: true, color: 'red', font: null });
    expect(a.compose(b)).toEqual(expected);
  });
  ...
  it('insert in middle of text', function () {
    ...
    var b = new Delta(5).retain(3).insert('X').retain(2);
  ...
  it('insert and delete ordering', function () {
    ...
    var insertFirst = new Delta(5).retain(3).insert('X').delete(1).retain(1);
    var deleteFirst = new Delta(5).retain(3).delete(1).insert('X').retain(1);
  ...
  it('insert embed', function () {
    var a = new Delta().insert({ embed: true }, { src: 'http://quilljs.com/image.png' });
    var b = new Delta(1).retain(1, { alt: 'logo' });
    var expected = new Delta().insert({ embed: true }, { src: 'http://quilljs.com/image.png', alt: 'logo' });
    expect(a.compose(b)).toEqual(expected);
  });

  xit('delete entire text', function () {
    var a = new Delta(4).retain(4).insert('Hello');
    var b = new Delta(9).delete(9);
    var expected = new Delta(4).delete(4);
    expect(a.compose(b)).toEqual(expected);
  });

  it('retain empty embed', function () {
    var a = new Delta().insert(1);
    var b = new Delta(1).retain(1);
  ...
  it('remove all attributes', function () {
    ...
    var b = new Delta(1).retain(1, { bold: null });
    var expected = new Delta().insert('A');
    expect(a.compose(b)).toEqual(expected);
  });

  it('remove all embed attributes', function () {
    var a = new Delta().insert({ embed: true }, { bold: true });
    var b = new Delta(1).retain(1, { bold: null });
    var expected = new Delta().insert({ embed: true });
    expect(a.compose(b)).toEqual(expected);
  });
  ...
  it('immutability', function () {
    ...
    var b1 = new Delta(4).retain(1, { color: 'red' }).delete(2);
    var b2 = new Delta(4).retain(1, { color: 'red' }).delete(2);
