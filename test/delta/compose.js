...
describe('compose()', function () {
  it('insert + insert', function () {
    ...
    var b = new Delta().insert('B').retain(1);
  ...
  it('delete + retain', function () {
    var a = new Delta().delete(1).retain(1);
  ...
  it('insert in middle of text', function () {
    ...
    var b = new Delta().retain(3).insert('X').retain(2);
  ...
  it('insert and delete ordering', function () {
    ...
    var insertFirst = new Delta().retain(3).insert('X').delete(1).retain(1);
    var deleteFirst = new Delta().retain(3).delete(1).insert('X').retain(1);
  ...
  it('immutability', function () {
    ...
    var b1 = new Delta().retain(1, { color: 'red' }).delete(2).retain(1);
    var b2 = new Delta().retain(1, { color: 'red' }).delete(2).retain(1);
