...
describe('compose()', function () {
  ...
  describe('custom embed handler', () => {
    ...
    it('retain an embed with a number', function () {
      var a = new Delta().insert({ delta: [{ insert: 'a' }] });
      var b = new Delta().retain(1, { bold: true });
    ...
    it('retain a number with an embed', function () {
      var a = new Delta().retain(10, { bold: true });
    ...
    it('retain an embed with an embed', function () {
      var a = new Delta().insert({ delta: [{ insert: 'a' }] });
      var b = new Delta().retain({ delta: [{ insert: 'b' }] });
      var expected = new Delta().insert({
        delta: [{ insert: 'ba' }],
